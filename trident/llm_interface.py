...
#         return prompt
    ...
    def build_multi_hop_prompt(
        ...
        prompt = (
            ...
            "You are answering a multi-hop question that requires combining information from multiple passages.\n"
            "Instructions:\n"
            "1. Use ONLY the information in the context above.\n"
            "2. Think step by step to connect the information across passages.\n"
            "3. Your response MUST end with exactly this format:\n"
            "   Final answer: <answer>\n"
            "   Where <answer> is:\n"
            "   - For yes/no questions: exactly 'yes' or 'no'\n"
            "   - For other questions: a short phrase, name, or entity (NOT a full sentence)\n"
            "4. Do NOT include explanations after 'Final answer:'\n"
            "5. If you cannot answer, use: Final answer: unknown\n\n"
            f"Question: {question}\n\n"
