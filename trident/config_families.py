...
SAFE_COVER_EQUAL_2500 = SafeCoverConfig(
    ...
    max_units=12,
    stop_on_budget=True,
    abstain_on_infeasible=True,  # Strict: abstain if cannot satisfy constraints
    fallback_to_pareto=False,  # No fallback - show true Safe-Cover behavior
    coverage_threshold=0.15,
    token_cap=2500,
    dual_tolerance=1e-6,
    early_abstain=True,
