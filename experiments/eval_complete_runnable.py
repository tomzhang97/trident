...
class ExperimentRunner:
    ...
    def _load_config_family(self) -> TridentConfig:
        ...
        if mode == "pareto":
            ...
            fallback_budget = (
                safe_cover_cfg.max_evidence_tokens
                if safe_cover_cfg.max_evidence_tokens is not None
                else safe_cover_cfg.token_cap
            )
            ...
            config_dict["pareto"] = {
                "budget": fallback_budget or self.args.budget_tokens,
                "max_evidence_tokens": fallback_budget,
                "max_units": safe_cover_cfg.max_units,
                "stop_on_budget": safe_cover_cfg.stop_on_budget,
            }
        elif mode == "self_rag":
