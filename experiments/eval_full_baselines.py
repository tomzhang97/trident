...
def convert_2wiki_example(ex: Dict) -> Dict:
    ...
    for title, sentences in raw_context:
        # Normalize everything into a true sentence list (Hotpot-style)
        sent_list = _normalize_to_sentence_list(sentences, max_sents=60)
        final_context.append([title, sent_list])
